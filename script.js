        ...
        if (player1TF.value != '' && player2TF.value != '') {
            playersNameElt.addEventListener("click", (e) => {
                if (e.target.classList.contains("playersNameSubmit")) {
                    ...
                    resolve("add names sucssed");
                }
            })
        } else {
            alert("Please Enter Players Name!");
            reject("add names faild!");
        }
    });
}
...
function gameDataToJson() {
    ...
    jsonConfig = JSON.stringify(congif);
...
function timer_4X4() {
    let promise = new Promise((resolve, reject) => {
        ...
        if (click4X4 == -1) {
            ...
            resolve('timer4X4 start');
        } else {
            reject('timer4X4 stop')
        }
    });
}
...
function timer_5X5() {
    let promise = new Promise((resolve, reject) => {
        if (click5X5 == -1) {
            ...
            resolve('timer5X5 start');
        } else {
            reject('timer5X5 stop')
        }
    });
}
...
function differentCards4X4() {
    ...
    let promise = new Promise((resolve, reject) => {
        ...
        resolve('differentCards4X4 Sucsses');
    });
...
function differentCards5X5() {
    ...
    let promise = new Promise((resolve, reject) => {
        ...
        resolve('differentCards5X5 Sucsses');
    });
    if (isPlayer1ArePlaying == true) {
        isPlayer1ArePlaying = false;
